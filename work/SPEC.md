...
> Four-surface framing (map / drawer / list / swipe stack) and the v1 → v2 → v3 progression are documented in `context/UX_STRATEGY.md`. The demo cut below is the v1 framing — "city wallet that surfaces offers when the moment is right" — bridged to v2 by the cross-merchant swipe stack already shipped.
