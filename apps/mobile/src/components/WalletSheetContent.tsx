...
type Props = {
  ...
  /**
   * Fired when the user taps a merchant card in the merchant list.
   * App.tsx wires this to the surfaced offer flow when the merchant
   * has an `active_offer`. Issue #116.
   */
